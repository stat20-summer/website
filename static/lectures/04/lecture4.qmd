...
-   This might be a difficult visualization to truly sink ones teeth into. Therefore, is there an alternative which compromises completeness but is easier to interpret and still gives the shape of the distribution?
...
- Yet, Haslem & Joe Johnson probably *skew* the data to the right. Is there a measure of center which accounts for this?
...
-   Use the scale to find the *25 percentile*, *median*, *75th percentile*,
*IQR*, *minimum*, *maximum* and any potential outliers.
