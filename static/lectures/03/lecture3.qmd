...
-   Big sports fan
    ...
    -   *Atlanta Falcons*, boxing, *Tampa Bay Rays*, *Tampa Bay Lightning*

-   Big music fan

    -   did a capella in college, my favorite artists are *Kendrick Lamar*, *Anderson .Paak*, and *Curren$y*
...
-   Will focus on answering Questions Two and Three
    ...
    -   I'll touch on this material today in class
...
-   Let's take a look at the code to segue into our next topic. At this point I pulled up an RStudio session and went over the code, noting the **R comments** I made.
...
## New code 
new_column <- arrange(new_column, bill_ratio)
...
-   Here's another question that we might want to answer using data.

. . .

>  test

-   Sketch a provisional dataset that would help answer this question.
