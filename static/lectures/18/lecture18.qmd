...
- The $Normal(\mu = 75, \sigma = 2)$ Distribution:
...
-   This is because we are working with a *continuous distribution** with infinitely many values on the real line! We can only talk about probabilities with inequalities in this situation.
