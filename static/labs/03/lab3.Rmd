...
From this point forward in this question, imagine that the sample collected by the Pew Research Center is indeed the population that the authors are trying to generalize to. Assume also that the population is 10,000 people and that everyone in the population gave a recorded response to the question (there is no such thing as not answering the question).
