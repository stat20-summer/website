...
2.  Post your lie to an Ed forum your GSI will create. It will be titled \[Your Section Number\]
...
When you open an R session within RStudio, there are four main "blocks" of the screen:

-   The bottom-left block is called the **console**. It is the heart and soul of the R session. You can type commands into the prompt \`\>\` and press enter/return to run them.

-   If you make any objects or load any data sets with your commands in the **console**, you can view them in the **environment** block in the top-right.

. . .

## RStudio

-   The **editor** is where you will be working most of the time. It is the top-left block. You can edit *R code files (.R files)* and *RMarkdown files (.Rmd files)* here.

-   Last but not least, the **file directory** is the bottom-right block. Here you can access all the files in your DataHub-- both those you make and upload.

-   **Note:** This layout is the default. If you want to change it, go to the *Pane Layout* section of *Preferences*.

. . .

## RMarkdown

-   You can open an RMarkdown file in RStudio by selecting *File*, followed by *New File* and *RMarkdown*.

-   Once you fill in some initial details about your document, a document will open up with two view modes: *Source* and *Visual.*

-   Previously we have taught *Source*, but using *Visual* first will likely be more useful to you since you can hit the ground running quicker and also learn how what you are typing translates to the source document.

-   To insert R code chunks in your document, just go to *Insert*, followed by *Code Chunk* and *R*.
